...
#include "ISXEQGmail.h"

// The mandatory pre-setup function.  Our name is "ISXEQGmail", and the class is ISXEQGmail.
...
// our instanced class.
ISXPreSetup("ISXEQGmail", ISXEQGmail);
...
bool ISXEQGmail::Initialize(ISInterface *p_ISInterface)
{
	...
	WriteChatf("ISXEQGmail Loaded");
	return true;
}

// shutdown sequence
void ISXEQGmail::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQGmailXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQGmailXML);
...
void ISXEQGmail::ConnectServices()
{
...
void ISXEQGmail::RegisterCommands()
{
	// add any commands
...
void ISXEQGmail::RegisterAliases()
{
	// add any aliases
}

void ISXEQGmail::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQGmail::UnRegisterCommands()
{
	// remove commands
	//    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQGmail::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQGmail::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQGmail::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
	//    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQGmail::UnRegisterServices()
{
	// shutdown our own services
	//    if (hISXEQGmailService)
	//        pISInterface->ShutdownService(this,hISXEQGmailService);
}

void ISXEQGmail::LoadSettings()
{
	bool bChanged = false;

	// open the settings file, and store the ID number in ISXEQGmailXML
	ISXEQGmailXML = pISInterface->OpenSettings(XMLFileName);
	...
	Any set can be referred to by its ID.  The base set is stored in ISXEQGmailXML.  Note that the settings
	...
	*/
	...
	if (unsigned int GeneralGUID = pISInterface->FindSet(ISXEQGmailXML, "General"))
	{
