...
#include "ISXEQViewport.h"

// The mandatory pre-setup function.  Our name is "ISXEQViewport", and the class is ISXEQViewport.
...
// our instanced class.
ISXPreSetup("ISXEQViewport",ISXEQViewport);
...
unsigned int ISXEQViewportXML=0;
...
bool ISXEQViewport::Initialize(ISInterface *p_ISInterface)
...
WriteChatf("ISXEQViewport Loaded");
return true;
}

// shutdown sequence
void ISXEQViewport::Shutdown()
{
    // save settings, if you changed them and want to save them now.  You should normally save
    // changes immediately.
    //pISInterface->ExportSet(ISXEQViewportXML,XMLFileName);

    pISInterface->UnloadSet(ISXEQViewportXML);
...
void ISXEQViewport::ConnectServices()
{
...
void ISXEQViewport::RegisterCommands()
{
    // add any commands
...
void ISXEQViewport::RegisterAliases()
{
    // add any aliases
}

void ISXEQViewport::RegisterDataTypes()
{
    // add any datatypes
    // pMyType = new MyType;
...
void ISXEQViewport::UnRegisterCommands()
{
    // remove commands
    //    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQViewport::UnRegisterAliases()
{
    // remove aliases
}
void ISXEQViewport::UnRegisterDataTypes()
{
    // remove data types
    //if (pMyType)
    //{
...
void ISXEQViewport::UnRegisterTopLevelObjects()
{
    // remove Top-Level Objects
    //    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQViewport::UnRegisterServices()
{
    // shutdown our own services
    //    if (hISXEQViewportService)
    //        pISInterface->ShutdownService(this,hISXEQViewportService);
}

void ISXEQViewport::LoadSettings()
{
    bool bChanged=false;

    // open the settings file, and store the ID number in ISXEQViewportXML
    ISXEQViewportXML=pISInterface->OpenSettings(XMLFileName);
    ...
    Any set can be referred to by its ID.  The base set is stored in ISXEQViewportXML.  Note that the settings
    ...
    */
    ...
    if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQViewportXML,"General"))
    {
