...
{
    DebugSpewAlways("Initializing MQ2Yes");
...
{
    DebugSpewAlways("Shutting down MQ2Yes");
...
{
    DebugSpewAlways("MQ2Yes::OnZoned()");
}
...
{
    DebugSpewAlways("MQ2Yes::OnCleanUI()");
...
{
    DebugSpewAlways("MQ2Yes::OnReloadUI()");
...
PLUGIN_API VOID OnDrawHUD(VOID)
{
    ...
    //DebugSpewAlways("MQ2Yes::OnDrawHUD()");
}

// Called once directly after initialization, and then every time the gamestate changes
PLUGIN_API VOID SetGameState(DWORD GameState)
{
    DebugSpewAlways("MQ2Yes::SetGameState()");
...
{
    // DONT leave in this debugspew, even if you leave in all the others
    //DebugSpewAlways("MQ2Yes::OnPulse()");
}
...
{
    DebugSpewAlways("MQ2Yes::OnWriteChatColor(%s)",Line);
    return 0;
}
...
{
    DebugSpewAlways("MQ2Yes::OnIncomingChat(%s)",Line);
    return 0;
}
...
{
    DebugSpewAlways("MQ2Yes::OnAddSpawn(%s)",pNewSpawn->Name);
}
...
{
    DebugSpewAlways("MQ2Yes::OnRemoveSpawn(%s)",pSpawn->Name);
}
...
{
    DebugSpewAlways("MQ2Yes::OnAddGroundItem(%d)",pNewGroundItem->DropID);
}
