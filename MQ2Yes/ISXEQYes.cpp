...
// The mandatory pre-setup function.  Our name is "ISXEQYes", and the class is ISXEQYes.
...
bool ISXEQYes::Initialize(ISInterface *p_ISInterface)
{
	...
	WriteChatf("ISXEQYes Loaded");
	return true;
}

// shutdown sequence
void ISXEQYes::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQYesXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQYesXML);
...
void ISXEQYes::RegisterCommands()
{
	// add any commands
...
void ISXEQYes::RegisterAliases()
{
	// add any aliases
}

void ISXEQYes::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQYes::UnRegisterCommands()
{
	// remove commands
	//    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQYes::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQYes::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQYes::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
	//    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQYes::UnRegisterServices()
{
	// shutdown our own services
	//    if (hISXEQYesService)
	//        pISInterface->ShutdownService(this,hISXEQYesService);
}

void ISXEQYes::LoadSettings()
{
	bool bChanged = false;

	// open the settings file, and store the ID number in ISXEQYesXML
	ISXEQYesXML = pISInterface->OpenSettings(XMLFileName);
	...
	Any set can be referred to by its ID.  The base set is stored in ISXEQYesXML.  Note that the settings
	...
	*/
	...
	if (unsigned int GeneralGUID = pISInterface->FindSet(ISXEQYesXML, "General"))
	{
