...
/*0x0031*/ bool		dShow; \
/*0x0032*/ bool		bKeepOnScreen; \
/*0x0033*/ BYTE     bResizableMask; \
/*0x0034*/ COLORREF DisabledBackground; \
/*0x0038*/ bool		bBorder; \
/*0x003C*/ RECT		ClientRect; \
/*0x004C*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x004D*/ BYTE		Alpha; \
/*0x004E*/ bool		bBorder2; \
/*0x0050*/ void*	pTextObject; \
/*0x0054*/ UINT		TransitionDuration; \
/*0x0058*/ __int64		Data; \
/*0x0060*/ int		DeleteCount; \
/*0x0064*/ bool		bRightAnchoredToLeft; \
...
/*0x0091*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0094*/ int		BottomOffset; \
/*0x0098*/ RECT		Location; \
/*0x00A8*/ bool		bScreenClipRectChanged; \
...
/*0x0126*/ bool		bMaximizable; \
/*0x0127*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0128*/ bool		bClientRectChanged; \
/*0x0129*/ bool		bUseInLayoutVertical; \
/*0x012C*/ void   *TitlePiece; \
/*0x0130*/ void	*IconTextureAnim; \
/*0x0134*/ bool		bBottomAnchoredToTop; \
...
/*0x015C*/ bool		bBringToTopWhenClicked; \
...
/*0x01AD*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01AE*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01AF*/ bool		bTopAnchoredToTop; \
/*0x01B0*/ RECT		ClipRectScreen; \
/*0x01C0*/ bool		bIsTransitioning; \
/*0x01C1*/ bool		bEscapableLocked; \
/*0x01C2*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55AA7E) in Nov  4 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 55A36E) in Nov  4 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 55A205) in Nov  4 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 55A0A9) in Nov  4 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FB1EB) in Nov  4 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55A467) in Nov  4 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FB2FC) in Nov  4 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 75E262) in Nov  4 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55A7D6) in Nov  4 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 559F0A) in Nov  4 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55A932) in Nov  4 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 559961) in Nov  4 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 559C52) in Nov  4 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55A9D8) in Nov  4 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55AB24) in Nov  4 2020 Beta - eqmule
