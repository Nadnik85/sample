// RGTemplate.cpp : Defines the entry point for the DLL application.
//
...
{
	DebugSpewAlways("Initializing RGTemplate");
...
{
	DebugSpewAlways("Shutting down RGTemplate");
...
{
	DebugSpewAlways("RGTemplate::OnZoned()");
}
...
{
	DebugSpewAlways("RGTemplate::OnCleanUI()");
...
{
	DebugSpewAlways("RGTemplate::OnReloadUI()");
...
PLUGIN_API VOID OnDrawHUD(VOID)
{
	...
	//DebugSpewAlways("RGTemplate::OnDrawHUD()");
}

// Called once directly after initialization, and then every time the gamestate changes
PLUGIN_API VOID SetGameState(DWORD GameState)
{
	DebugSpewAlways("RGTemplate::SetGameState()");
...
{
	// DONT leave in this debugspew, even if you leave in all the others
	//DebugSpewAlways("RGTemplate::OnPulse()");
}
...
{
	DebugSpewAlways("RGTemplate::OnWriteChatColor(%s)", Line);
	return 0;
}
...
{
	DebugSpewAlways("RGTemplate::OnIncomingChat(%s)", Line);
	return 0;
}
...
{
	DebugSpewAlways("RGTemplate::OnAddSpawn(%s)", pNewSpawn->Name);
}
...
{
	DebugSpewAlways("RGTemplate::OnRemoveSpawn(%s)", pSpawn->Name);
}
...
{
	DebugSpewAlways("RGTemplate::OnAddGroundItem(%d)", pNewGroundItem->DropID);
}
...
{
	DebugSpewAlways("RGTemplate::Zoned");
}