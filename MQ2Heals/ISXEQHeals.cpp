...
#include "ISXEQHeals.h"

// The mandatory pre-setup function.  Our name is "ISXEQHeals", and the class is ISXEQHeals.
...
// our instanced class.
ISXPreSetup("ISXEQHeals", ISXEQHeals);
...
bool ISXEQHeals::Initialize(ISInterface *p_ISInterface)
{
	...
	WriteChatf("ISXEQHeals Loaded");
	return true;
}

// shutdown sequence
void ISXEQHeals::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQHealsXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQHealsXML);
...
void ISXEQHeals::ConnectServices()
{
...
void ISXEQHeals::RegisterCommands()
{
	// add any commands
...
void ISXEQHeals::RegisterAliases()
{
	// add any aliases
}

void ISXEQHeals::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQHeals::UnRegisterCommands()
{
	// remove commands
	//    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQHeals::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQHeals::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQHeals::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
	//    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQHeals::UnRegisterServices()
{
	// shutdown our own services
	//    if (hISXEQHealsService)
	//        pISInterface->ShutdownService(this,hISXEQHealsService);
}

void ISXEQHeals::LoadSettings()
{
	bool bChanged = false;

	// open the settings file, and store the ID number in ISXEQHealsXML
	ISXEQHealsXML = pISInterface->OpenSettings(XMLFileName);
	...
	Any set can be referred to by its ID.  The base set is stored in ISXEQHealsXML.  Note that the settings
	...
	*/
	...
	if (unsigned int GeneralGUID = pISInterface->FindSet(ISXEQHealsXML, "General"))
	{
